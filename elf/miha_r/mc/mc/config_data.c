...
__root const CFG_HDR cfghdr_m50 = { CFG_LEVEL, psz_sm_autoexit, 1, 0 };
	...
	__root const CFG_HDR cfghdr23 = { CFG_CBOX, psz_autoexit_on_background, 0, 2 };
