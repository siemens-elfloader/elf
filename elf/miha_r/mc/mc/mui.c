...
void InitMUI()
{
	...
	opt_menuitems[0].lgp_id_small = (int)muitxt(ind_open);
        opt_menuitems[1].lgp_id_small = (int)muitxt(ind_altopen);
        opt_menuitems[2].lgp_id_small = (int)muitxt(ind_natexpl);
	opt_menuitems[3].lgp_id_small = (int)muitxt(ind_file_m);
	opt_menuitems[4].lgp_id_small = (int)muitxt(ind_oper_m);
	opt_menuitems[5].lgp_id_small = (int)muitxt(ind_prop);
	opt_menuitems[6].lgp_id_small = (int)muitxt(ind_view_m);
	opt_menuitems[7].lgp_id_small = (int)muitxt(ind_misc_m);
	opt_menuitems[8].lgp_id_small = (int)muitxt(ind_exit);

	i = 0;
	zip_opt_menuitems[i++].lgp_id_small = (int)muitxt(ind_open);
        zip_opt_menuitems[i++].lgp_id_small = (int)muitxt(ind_altopen);
	...
	mis_menuitems[0].lgp_id_small = (int)muitxt(ind_bm_m);
        mis_menuitems[1].lgp_id_small = (int)muitxt(ind_keyhelp);
	mis_menuitems[2].lgp_id_small = (int)muitxt(ind_drvinf);
	mis_menuitems[3].lgp_id_small = (int)muitxt(ind_settings);
	mis_menuitems[4].lgp_id_small = (int)muitxt(ind_about_m);
