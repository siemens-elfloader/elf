...
#define IPC_SMSMAN_NAME "∂Ã–≈π‹¿Ì∆˜"

#define IPC_CHECK_DOUBLERUN	1
#define IPC_OPEN_GUI		2

extern const char InSMSSound[], IDLETXT[], SMS_DAT_PATH[], PNG_FNT_PATH[];
extern const unsigned int IDLE_X, IDLE_Y, IDLE_FNT, IDLEICON_X, IDLEICON_Y, SPACE,
	...
	extern const int SHOW0NEW, IN_NOTIFY, SHOW_IDLE_TEXT, SHOW_IDLE_PIC, FULLFONT, ALIGN, TYPE_FNT,
