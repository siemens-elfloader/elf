...
//  extern const char _END_OF_CONFIG;
  unsigned int len=(int)__segment_end("CONFIG_C")-(int)__segment_begin("CONFIG_C");
  //unsigned int len=((char*)&_END_OF_CONFIG)-((char*)cfg);
...
void InitConfig()
{
  if (LoadConfigData("4:\\ZBin\\etc\\macro.bcfg")<0)
  {
    LoadConfigData("0:\\ZBin\\etc\\macro.bcfg");
  }
  //recalc delays
}
