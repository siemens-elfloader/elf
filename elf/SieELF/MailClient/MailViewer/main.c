...
void gb_2ws(WSHDR *ws, const char *s)//gb2ws
{
  gb2ws(ws, s, strlen(s));
}
...
const char eml_not_found[]="错误! 文件没有找到!";
...
HEADER_DESC saveas_hdr={0,0,0,0,NULL,(int)"正在保存中",LGP_NULL};
...
HEADER_DESC ed1_hdr={0,0,0,0,NULL,(int)"查看",LGP_NULL};

HEADER_DESC ed2_hdr={0,0,0,0,NULL,(int)"信息",LGP_NULL};
...
{
  {NULL,(int)"检查邮件",     LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //0
  {NULL,(int)"下载",           LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //1
  {NULL,(int)"不要下载",        LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //2
  {NULL,(int)"删除",             LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //3
  {NULL,(int)"不要删除",          LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //4
  {NULL,(int)"全部删除",         LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //5
  {NULL,(int)"移除记录",      LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //6
  {NULL,(int)"清空列表",     LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //7
  {NULL,(int)"下载全部",       LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //8
  {NULL,(int)"信息",          LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //9
  {NULL,(int)"返回",               LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //10
};
...
HEADER_DESC maillist_menuhdr={0,0,0,0,NULL,(int)"收件箱",LGP_NULL};
...
{
  {NULL,(int)"收件箱",  LGP_NULL,0,NULL,MENU_FLAG3,MENU_FLAG2},
  {NULL,(int)"发件箱", LGP_NULL,0,NULL,MENU_FLAG3,MENU_FLAG2},
  {NULL,(int)"选项", LGP_NULL,0,NULL,MENU_FLAG3,MENU_FLAG2},
  {NULL,(int)"统计",LGP_NULL,0,NULL,MENU_FLAG3,MENU_FLAG2},
