...
без кавычек, конечно.
 !!! На диске нужен каталог 4:\ZBin\TED - туда пишется файл с историей просмотра. Туда же положите ted.elf и файлы *.fnt.
 !!! Свободного места на диске надо не менее, чем размер файла, который вы хотите загрузить.

 Шрифт 4*8, 6*8, 8*8, 8*14, 8*16. Для редактирования шрифтов используется программа Siemens Character Editor - установить
размер шрифта 8(width) на 7(height) и снять все галочки. Для шрифтов высоты 14 и 16 - соответственно height - 13 и 15. 
Для шрифта 4*8 символы должны дублироваться по 2 в одном знакоместе - увидите сами при загрузке уже сделаного 4.fnt.
...
по горизонтали - по 8 символов. Долгое нажатие влево/вправо - переход по словам
 ...
 Font size = 14 - установить размер шрифта 8*14
 Font size = 16 - установить размер шрифта 8*16
