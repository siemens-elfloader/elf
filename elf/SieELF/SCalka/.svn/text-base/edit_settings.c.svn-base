...
{
  static SOFTKEY_DESC sk_save={0x0FFF,0x0000,(int)"±Јґж"};
  WSHDR *ws, locws;
...
static HEADER_DESC view_settings_hdr={0,0,0,0,NULL,(int)"Йи¶Ё",LGP_NULL};
