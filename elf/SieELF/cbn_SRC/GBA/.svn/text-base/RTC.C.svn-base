...
u16 rtcRead(u32 address)
{
  ...
  return ROMREADH(address);//READ16LE((&rom[address & 0x1FFFFFE]));
}
...
void rtcSaveGame(gzFile gzFile1)
{
  utilGzWrite(gzFile1, &rtcClockData, sizeof(rtcClockData));
}

void rtcReadGame(gzFile gzFile1)
{
  utilGzRead(gzFile1, &rtcClockData, sizeof(rtcClockData));
}
