...
static _u16 s2ample_chip_tone(void)
{
	int i;
...
static _u16 s2ample_chip_noise(void)
{
	int i;
...
void W2riteSoundChip(SoundChip* chip, _u8 data)
{
...
void s2ound_init(int SampleRate)
{
	int i;
	double out;
