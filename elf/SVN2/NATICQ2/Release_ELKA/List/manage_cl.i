...
{
  {S_ICONS+ICON_ALL_CAN_SEE,         (int)"Видим всем",           0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_INVISLIST_CANNOT_SEE,(int)"Невидим для списка",  0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_CONTACTLIST_CAN_SEE, (int)"Видим для КЛ",   0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_VISLIST_CAN_SEE,     (int)"Видим для списка",       0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_NOBODY_CAN_SEE,      (int)"Невидим всем",        0x7FFFFFFF,0,0,3,0x5A2}
};
...
static MENUITEM_DESC mmanage_cl_ITEMS[2]=
{
...
static HEADER_DESC mmanage_cl_HDR={0,0,0,0,0,0,0x7FFFFFFF};
