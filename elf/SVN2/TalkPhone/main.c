...
void SayMinVoice()
{
    if (CurTime.min>=10 && CurTime.min<=19) Play(folder_path, "min3.amr");
      else
        {
          switch (CurTime.min%10)
            {
              case 1:
                Play(folder_path, "min2.amr");
              break;
              case 2: case 3: case 4:
                Play(folder_path, "min1.amr");
              break;
              case 0: case 5: case 6: case 7: case 8: case 9: 
                Play(folder_path, "min3.amr");
              break;  
            }
        }
    NEXT_PLAY_FUNK=0;
    ...
    if (CurTime.min!=0)
      {
        if (CurTime.min%10==1) 
          {
            Play(folder_path, "1_2.amr");
            NEXT_PLAY_FUNK=5;
          }
          else
        if (CurTime.min%10==2) 
          {
            Play(folder_path, "2_1.amr");          
            NEXT_PLAY_FUNK=5;
          }
          else
            {
              char s[5];
              sprintf(s, "%d.amr", CurTime.min%10);            
              Play(folder_path, s);  
              NEXT_PLAY_FUNK=5;
            }
      }
...
void SayHourVoice()
{
        switch (CurTime.hour)
          {
            case 1: case 21:
              Play(folder_path, "hour2.amr");
              NEXT_PLAY_FUNK=3;
            break;
          
            case 2: case 3: case 4: case 22: case 23:
              Play(folder_path, "hour3.amr");
              NEXT_PLAY_FUNK=3;
            break;
...
void SayHourDig()
{
      if (CurTime.hour==1) 
        {
          Play(folder_path, "1_1.amr");
          NEXT_PLAY_FUNK=2;
        }
        else
      if (CurTime.hour==2) 
        {
          Play(folder_path, "2_2.amr");          
          NEXT_PLAY_FUNK=2;
        }
        else
          {
            char s[6];
            sprintf(s, "%d.amr", CurTime.hour);            
            Play(folder_path, s);
            NEXT_PLAY_FUNK=2;
          }
}
