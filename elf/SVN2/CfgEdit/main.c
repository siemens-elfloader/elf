...
void ClearT9Key(char *T9_key)
{
  zeromem(T9_key,sizeof(T9_key));
}


void AddT9Key(char *T9_key,int chr)
{
  int l=strlen(T9_key);
  if (l<(sizeof(T9_key)-1))
  {
    T9_key[l]=chr;
  }
}

void BackSpaceT9(char *T9_key)
{
  int l=strlen(T9_key);
  if (l)
  {
