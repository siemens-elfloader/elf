...
__root const CFG_HDR cfghdrm1_3={CFG_STR_WIN1251,"Текст выкл. MP",1,127};
__root const char text_mp_off[128]="Медиаплеер выключен";

__root const CFG_HDR cfghdrm1_4={CFG_STR_WIN1251,"Текст вкл. MP",1,127};
__root const char text_mp_on[128]="Медиаплеер включен";
...
__root const CFG_HDR cfghdr2_3={CFG_STR_UTF8,"Путь к иконке выкл. MP",1,127};
__root const char img_mp_off[128]="4:\\ZBin\\img\\MPStat\\mp_off.png";

__root const CFG_HDR cfghdr2_4={CFG_STR_UTF8,"Путь к иконке вкл. MP",1,127};
__root const char img_mp_on[128]="4:\\ZBin\\img\\MPStat\\mp_on.png";
