...
__root const CFG_HDR cfghdr3 = { CFG_UINT, psz_scspeed, 0, 2000 };
__root const int CONFIG_SCROLL_TEXT_SPEED = 10;

__root const CFG_HDR cfghdr4 = { CFG_UINT, psz_scwait, 0, 200 };
__root const int CONFIG_SCROLL_TEXT_WAIT = 10;

__root const CFG_HDR cfghdr5 = { CFG_CBOX, psz_useboldf, 0, 2 };
...
__root const CFG_HDR cfghdr10 = { CFG_CBOX, psz_loadicons, 0, 2 };
__root const int CONFIG_LOAD_ICONS = 1;
__root const CFG_CBOX_ITEM cfgcbox10[] = { psz_no, psz_yes };

__root const CFG_HDR cfghdr11 = { CFG_CBOX, psz_loadkeys, 0, 2 };
__root const int CONFIG_LOAD_KEYS = 1;
__root const CFG_CBOX_ITEM cfgcbox11[] = { psz_no, psz_yes };

__root const CFG_HDR cfghdr12 = { CFG_CBOX, psz_loadmui, 0, 2 };
__root const int CONFIG_LOAD_MUI = 1;
__root const CFG_CBOX_ITEM cfgcbox12[] = { psz_no, psz_yes };

__root const CFG_HDR cfghdr13 = { CFG_CBOX, psz_loadcs, 0, 2 };
__root const int CONFIG_LOAD_CS = 1;
__root const CFG_CBOX_ITEM cfgcbox13[] = { psz_no, psz_yes };

__root const CFG_HDR cfghdr14 = { CFG_STR_UTF8, psz_configpath, 0, 63 };
__root const char CONFIG_MCCONFIG_PATH[64] = DEFAULT_DISK":\\ZBin\\mc";
...
__root const CFG_HDR cfghdr21 = { CFG_UINT, psz_autoexit_after, 0, 2000 };
__root const int CONFIG_AUTO_EXIT_AFTER_MIN = 30;

__root const CFG_HDR cfghdr22 = { CFG_CBOX, psz_autoexit_on_background, 0, 2 };
__root const int CONFIG_ENABLE_BACKGROUND_EXIT = 0;
__root const CFG_CBOX_ITEM cfgcbox22[] = { psz_no, psz_yes };
...
__root const CFG_HDR cfghdr23 = { CFG_CBOX, psz_zip_enable, 0, 2 };
__root const int CONFIG_ZIP_ENABLE = 1;
__root const CFG_CBOX_ITEM cfgcbox23[] = { psz_no, psz_yes };

__root const CFG_HDR cfghdr24 = { CFG_STR_UTF8, psz_temppath, 0, 63 };
