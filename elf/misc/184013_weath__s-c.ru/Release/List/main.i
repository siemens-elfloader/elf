...
__swi __arm int utf8_2ws(WSHDR *ws,char *utf8_str, unsigned int maxLen);
...
{
  {(int*)768,(int)"Выход",0x7FFFFFFF,0,0 ,0,0x59D},
  {(int*)769,(int)"Об эльфе...",0x7FFFFFFF,0,0 ,0,0x59D},
  {(int*)789,(int)"Об эльфе...",0x7FFFFFFF,0,0 ,0,0x59D}
};
...
HEADER_DESC menuhdr={0,0,131,21,0,(int)"Опции",0x7FFFFFFF};
...
void create_connect(void)
{
  ...
  if (sock!=-1)
  {
    sa.family=1;
    sa.port=htons(80);
    sa.ip=htonl((((unsigned long)212<<24)|((unsigned long)48<<16)|((unsigned long)138<<8)|((unsigned long)18<<0)));
...
int OnKey(MAIN_GUI *data, GUI_MSG *msg)
{
  if (msg->gbsmsg->msg==0x193)
  {
    ...
    case '2': case 0x3B:    x=(x+6)%7; REDRAW(); break;
    case '4': case 0x3D:  y=(y+3)%4; REDRAW(); break;
    case '6': case 0x3E: y=(y+1)%4; REDRAW(); break;
    case '8': case 0x3C:  x=(x+1)%7; REDRAW(); break;
    ...
    case '#':{  gipc.name_to=ipc_xtask_name;
                ...
                gipc.data=0;
                GBS_SendMessage(0x4209,0x3F2,1,&gipc);} break;
    
    case 0x0B:  SUBPROC((void *)create_connect); break;
...
int maincsm_onmessage(CSM_RAM *data, GBS_MSG *msg)
{
 ...
 
  {
	...
	if (idata)
	{
	  void *canvasdata=((void **)idata)[0x14/4];
