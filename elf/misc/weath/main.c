...
GetDateTime(&date,&time); 
  ...
  DrawString(ws,2,5,129,172,8,34,GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex(1)); 
 ...
 // DrawString(ws,20,ScreenH()-100,131,172,7,32,GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex(1)); 
  ...
  DrawString(ws,20,ScreenH()-100,131,172,7,32,GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex((x==0)?3:1)); 
  
  wsprintf(ws,"%i-%i %t",weath[y].pressure,weath[y].pressure+2,"мм.рт.ст");
  DrawString(ws,20,ScreenH()-85,131,172,7,32,GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex((x==1)?3:1)); 
  
  wsprintf(ws,"%t ",cloudness[weath[y].cloudiness]);
  DrawString(ws,20,ScreenH()-70,131,172,7,32,GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex((x==2)?3:1)); 
  
  wsprintf(ws,"%t  ",l);
  DrawString(ws,20,ScreenH()-55,131,172,7,32,GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex((x==3)?3:1)); 
  
  wsprintf(ws,"%t%t %i-%i %t","Ветер:", wind[weath[y].wind_dir],weath[y].wind_min,weath[y].wind_max,"м/с");
  DrawString(ws,20,ScreenH()-40,131,172,7,32,GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex((x==4)?3:1)); 
  
  wsprintf(ws,"%t: %i-%i%%","Влажность",weath[y].relwet,(weath[y].relwet+5>100)?100:weath[y].relwet+5);
  DrawString(ws,20,ScreenH()-25,131,172,7,32,GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex((x==5)?3:1)); 
...
void DrawWait()
{
  DrawImg(0,0,(int)"0:\\Zbin\\netutils\\weather\\wait.png");
  WSHDR *ws = AllocWS(1024);
    wsprintf(ws,"%s",logbuf);
    DrawString(ws,2,5,127,172,7,4,GetPaletteAdrByColorIndex(0),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
//DrawRoundedFrame(IDLEICON_X,IDLEICON_Y,IDLEICON_X+70,IDLEICON_Y+20,4,4,0,GetPaletteAdrByColorIndex(1),GetPaletteAdrByColorIndex(0));
  ...
  DrawImg(CLOUD_ICON_X,CLOUD_ICON_Y,(int)pics[weath[y].cloudiness]);
          ...
          DrawString(wsx,TEMP_ICON_X,TEMP_ICON_Y,TEMP_ICON_X+100,TEMP_ICON_Y+20,7,2,GetPaletteAdrByColorIndex(1),GetPaletteAdrByColorIndex(23));
	  FreeWS (wsx);
        } }
      }
    }
