...
void FontPathInit(int num, char* path, int isFullSet, int maxNum ); // !!!при старте эльфа или если для функции используются данные из конфига то при реконфигурации
