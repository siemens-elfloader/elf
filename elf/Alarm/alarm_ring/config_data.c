...
__root const CFG_CBOX_ITEM cfgcbox0[4]={"file","standard","AlarmClockRing","shortcut"};
#else
__root const CFG_HDR cfghdr0={CFG_CBOX,"use",0,2};
__root const unsigned int play_=1;
...
__root const CFG_HDR cfghdr3={CFG_UINT,"vibra power",0,100};
