...
__root const CFG_HDR cfghdr_z1={CFG_LEVEL,"Fonts",1,0};

  __root const CFG_HDR cfghdr_z2={CFG_UINT,"font (1=png/1xx=system)",0,115};
  __root const unsigned int fonto=109;

  __root const CFG_HDR cfghdr_z3={CFG_LEVEL,"Png-Font Setup",1,0};

    __root const CFG_HDR cfghdr_z3_1={CFG_STR_UTF8,"Font path",0,63};
    __root const char fontpath[64]="2:\\font\\"; /*zbin\\img\\font\\*/
  
    __root const CFG_HDR cfghdr_z3_2={CFG_UINT,"ping/time/unread space",0,20};
    __root const unsigned int spaco1=1;

    __root const CFG_HDR cfghdr_z3_3={CFG_UINT,"main msg space",0,20};
    __root const unsigned int spaco2=1;
  
  __root const CFG_HDR cfghdr_z4={CFG_LEVEL,"",0,0};
  __root const CFG_HDR cfghdr_z5={CFG_LEVEL,"System-Font Setup",1,0};
  
    __root const CFG_HDR cfghdr_z5_1={CFG_UINT,"Font-color",0,20};
    __root const unsigned int system_color=1;
  
  __root const CFG_HDR cfghdr_z6={CFG_LEVEL,"",0,0};
  
__root const CFG_HDR cfghdr_z7={CFG_LEVEL,"",0,0};
...
__root const CFG_HDR cfghdr_69r={CFG_UINT,"TxT Lenght(letters)",0,40};
__root const unsigned int main_draw_l=38;
...
__root const CFG_HDR cfghdr467 = {CFG_CBOX,"Show with contacts",0,2};
__root const int TIME_OR_MSG = 1;
__root const CFG_CBOX_ITEM cfgcbox91[2]={"Time","Msg"};
