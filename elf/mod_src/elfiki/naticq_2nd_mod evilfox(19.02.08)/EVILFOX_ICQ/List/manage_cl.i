...
{
  {S_ICONS+ICON_ALL_CAN_SEE,         (int)"Visible for all",           0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_VISLIST_CAN_SEE,     (int)"Visible only for list seeing",       0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_INVISLIST_CANNOT_SEE,(int)"Visible for all, except for list blind",  0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_CONTACTLIST_CAN_SEE, (int)"Visible only for list of contacts",   0x7FFFFFFF,0,0,3,0x5A2},
  {S_ICONS+ICON_NOBODY_CAN_SEE,      (int)"Invisible for all",        0x7FFFFFFF,0,0,3,0x5A2}
};
...
{
  {0,(int)"Add Contact",      0x7FFFFFFF,0,0,3,0x5A2},
  {0,(int)"Private status",  0x7FFFFFFF,0,0,3,0x5A2},
};
