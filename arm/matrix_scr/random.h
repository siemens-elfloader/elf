...
const int rndmax=256;

// Random generator from ID software :)
...
//  rndidx=(time.min | (time.param<<5))&0x7ff;
}

inline unsigned char random(){
  if(++rndidx>=rndmax) rndidx=0;
  return *((unsigned char *)rndtab + rndidx);
