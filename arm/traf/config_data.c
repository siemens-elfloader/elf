...
__root const CFG_HDR cfghdr0_1={CFG_STR_WIN1251,"Включи gprs",0,127};
__root const char ERR1[128]="Enable gprs!";

__root const CFG_HDR cfghdr0_2={CFG_STR_WIN1251,"Запусти gprsd!!!!",0,127};
...
__root const CFG_HDR cfghdr7={CFG_STR_WIN1251,"Формат",0,127};
...
__root const CFG_HDR cfghdr15={CFG_STR_WIN1251,"Формат",0,127};
