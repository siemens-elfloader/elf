...
/*20:52:26 30.07 эвилфокс:
дефинируешь в конфиг const char putj[128]="4:\zbin\sub\";

и виводишь
char *path=malloc(128);
sprintf(path, "%skartinka.png", putj);
drawimg(x, y, path);
mfree(path);


if(getmissedevents(0)>0) play(linksound);
*/
...
void DrawWeatherLog()
{
  ...
  DrawString(ws,pos_msg_x+3,pos_msg_y+3,pos_msg_x+Get_WS_width(ws,font1)+3,pos_msg_y+GetFontYSIZE(font1)+3,font1,0,GetPaletteAdrByColorIndex(2),GetPaletteAdrByColorIndex(23));
  if(engade_weather)
  {
    wsprintf(ws, "On: %s", weather_time);
    DrawString(ws,pos_msg_x+3,pos_msg_y+18,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+18,font2,0,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
    wsprintf(ws, temp2);
    DrawString(ws,pos_msg_x+3,pos_msg_y+28,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+28,font2,0,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
    wsprintf(ws, vejsh2);
    DrawString(ws,pos_msg_x+3,pos_msg_y+38,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+38,font2,0,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
    wsprintf(ws, s_icon1);
    DrawString(ws,pos_msg_x+3,pos_msg_y+48,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+48,font2,0,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
  }
  else
  {
    wsprintf(ws, "No Data Yet");
    DrawString(ws,pos_msg_x+3,pos_msg_y+25,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+25,font2,0,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
  }
  FreeWS(ws);
}
#else
void DrawWeatherLog()
{
  ...
  DrawString(ws,pos_msg_x+3,pos_msg_y+3,pos_msg_x+Get_WS_width(ws,font1)+3,pos_msg_y+GetFontYSIZE(font1)+3,font1,0,COLORfont1,GetPaletteAdrByColorIndex(23));
  if(engade_weather)
  {
    wsprintf(ws, "On: %s", weather_time);
    DrawString(ws,pos_msg_x+3,pos_msg_y+18,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+18,font2,0,COLORfont2,GetPaletteAdrByColorIndex(23));
    ascii2ws(ws, temp2);
    DrawString(ws,pos_msg_x+3,pos_msg_y+28,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+28,font2,0,COLORfont2,GetPaletteAdrByColorIndex(23));
    ascii2ws(ws, vejsh2);
    //wsprintf(ws, vejsh2);
    DrawString(ws,pos_msg_x+3,pos_msg_y+38,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+38,font2,0,COLORfont2,GetPaletteAdrByColorIndex(23));
    ascii2ws(ws, pressure2);
   // wsprintf(ws, pressure2);
    DrawString(ws,pos_msg_x+3,pos_msg_y+48,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+48,font2,0,COLORfont2,GetPaletteAdrByColorIndex(23));
  }
  else
  {
    wsprintf(ws, "No Data Yet");
...
void DrawBatteryLog()
{
  ...
  DrawString(ws,pos_msg_x+3,pos_msg_y+38,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+38,font2,0,COLORfont2,GetPaletteAdrByColorIndex(23));
  wsprintf(ws, chinfo);
  DrawString(ws,pos_msg_x+18,pos_msg_y+48,pos_msg_x+Get_WS_width(ws,font2)+18,pos_msg_y+GetFontYSIZE(font2)+48,font2,0,COLORfont2,GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
...
void DrawSystemLog()
{
  ...
  unsigned int err;
  int freemem0 = GetFreeFlexSpace(0, &err)/1024;
  int freemem4 = GetFreeFlexSpace(4, &err)/1024; 
 ...
 //********************************************************************************** 
 // unsigned int err;
//int freemem = GetFreeFlexSpace(4, &err);

  //DrawString(ws,pos_msg_x+3,pos_msg_y+58,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+58,font2,0,COLORfont2,GetPaletteAdrByColorIndex(23));
...
void DrawNaticqLog()
{
 ...
 // DrawString(ws,pos_msg_x+3,pos_msg_y+35,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+35,font2,0,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
 // wsprintf(ws, "Runtime: %02d:%02d:%02d", r_h, r_m, r_s);
 // DrawString(ws,pos_msg_x+3,pos_msg_y+45,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+45,font2,0,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
 // wsprintf(ws,"FreeRam: %dKb", ram);
 // DrawString(ws,pos_msg_x+3,pos_msg_y+55,pos_msg_x+Get_WS_width(ws,font2)+3,pos_msg_y+GetFontYSIZE(font2)+55,font2,0,GetPaletteAdrByColorIndex(4),GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
#endif
...
#endif
    DrawString(ws,pos_link2_x-17,pos_link2_y-14,pos_link2_x+Get_WS_width(ws,font2)-17,pos_link2_y+GetFontYSIZE(font2)-14,font2,0,COLORfont2,GetPaletteAdrByColorIndex(23));
    FreeWS(ws);
    break;
  case 3:
  //  WSHDR *ws=AllocWS(64);
...
void OnRedraw(MAIN_GUI *data) // OnRedraw
{
  ...
  case 3:
    ...
    DrawImg(pos_main_x, pos_main_y, (int)"4:\\zbin\\miosd\\img1.png");
      ...
      if(app_pos==1)
        DrawImg(pos_link2_x-10, pos_link2_y-17, (int)"4:\\zbin\\miosd\\img7.png");
      else
        DrawImg(pos_link2_x-20, pos_link2_y-17, (int)"4:\\zbin\\miosd\\img7.png");
      DrawAppLog();
...
int OnKey(MAIN_GUI *data, GUI_MSG *msg) //OnKey
{
  if(lock_keys)
  {
    ...
    if(GetMissedEventCount(0)>0) play(linksound);
...
#ifdef EVILFOX
#else
  ShowMSG(1,(int)"MIOSD running (c)Evilfox (m)Z80 ");
#endif
