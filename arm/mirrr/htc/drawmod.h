...
if (int_settings[22]==0){//рисуем подложки для часов
...
ascii2ws(ws, "Для разблокировки");  DrawString( ws, 38,  185-yid,  230, 320-yid, 6, 1, colors[9], GetPaletteAdrByColorIndex( 23 ) );
ascii2ws(ws, "нажмите #");  DrawString( ws, 38,  208-yid,  230, 320-yid, 6, 1, colors[9], GetPaletteAdrByColorIndex( 23 ) );

	}
if (int_settings[22]==0){ //бааальшие часы
...
sprintf (pyfstr, "Заряд батареи: %i%c", battery, '%'); ascii2ws(ws, pyfstr); DrawString( ws, 58,  175,  230, 195, 8, 1, colors[9], GetPaletteAdrByColorIndex( 23 ) );
...
sprintf (pyfstr, "ОЗУ: %iKb", GetFreeRamAvail()/1024); ascii2ws(ws, pyfstr); DrawString( ws, 58,  190,  230, 210, 8, 1, colors[9], GetPaletteAdrByColorIndex( 23 ) );
...
DrawRectangle( 33, 198, 32+(((13*GetFreeRamAvail())/1024)/int_settings[25]),200, 0, colors[9], colors[9]);
    ...
    ascii2ws(ws, "Входящие"); DrawString( ws, 10,  300,  230, 320, 9, 1, colors[4], GetPaletteAdrByColorIndex( 23 ) );
    ascii2ws(ws, "Программы");  DrawString( ws, 10,  300,  230, 320, 9, 4, colors[4], GetPaletteAdrByColorIndex( 23 ) );
break;
//------------------------------------------
case 1:
     ascii2ws(ws, "Контакты"); DrawString( ws, 11,  27,  229, 320, 5, 3, colors[25], GetPaletteAdrByColorIndex( 23 ) );
    ...
    DrawRectangle( 0, 296, 240,320, 1, colors[3], colors[3]);
    ascii2ws(ws, "Больше"); DrawString( ws, 10,  300,  230, 320, 9, 1, colors[4], GetPaletteAdrByColorIndex( 23 ) );
    ascii2ws(ws, "Меню");  DrawString( ws, 10,  300,  230, 320, 9, 4, colors[4], GetPaletteAdrByColorIndex( 23 ) );

break;
//------------------------------------------
case 2:
     ascii2ws(ws, "Сообщения"); DrawString( ws, 11,  27,  229, 320, 5, 3, colors[25], GetPaletteAdrByColorIndex( 23 ) );
...
if((!SMSD[2].SMS_TEXT)||(SMSD[2].n!=1)) {ascii2ws(ws, "Нет новых сообщений");  DrawString( ws, 10,  145,  230, 320, 6, 3, colors[9], GetPaletteAdrByColorIndex( 23 ) );}
else  DrawString( SMSD[2].SMS_TEXT, 10,  145,  230, 320, 6, 3, colors[9], GetPaletteAdrByColorIndex( 23 ) );
/**============================================================================================*/


    DrawRectangle( 0, 296, 240,320, 1, colors[3], colors[3]);
    ascii2ws(ws, "Все"); DrawString( ws, 10,  300,  230, 320, 9, 1, colors[4], GetPaletteAdrByColorIndex( 23 ) );
    ascii2ws(ws, "Меню");  DrawString( ws, 10,  300,  230, 320, 9, 4, colors[4], GetPaletteAdrByColorIndex( 23 ) );
break;
//------------------------------------------
case 3:
     ascii2ws(ws, "Эл. почта"); DrawString( ws, 11,  27,  229, 320, 5, 3, colors[25], GetPaletteAdrByColorIndex( 23 ) );
...
DrawLine(111-SetIco[35]->w/2,100,240-(126-SetIco[35]->w/2)-18,100,1,colors[19]);
 ...
 ascii2ws(ws, "Новых писем нет"); DrawString( ws, 113-(SetIco[35]->w/2)+3,  67,  240-(126-SetIco[35]->w/2)-3, 80, 9, 1, colors[20], GetPaletteAdrByColorIndex( 23 ) );
...
ascii2ws(ws, "Не обнаружено новых писем в почтовом ящике!");
...
DrwPngImg(SetIco[35], 105-SetIco[35]->w/2, 190-SetIco[35]->h/2);
    ...
    DrawRectangle( 0, 296, 240,320, 1, colors[3], colors[3]);
    ascii2ws(ws, "Получить"); DrawString( ws, 10,  300,  230, 320, 9, 1, colors[4], GetPaletteAdrByColorIndex( 23 ) );
    ascii2ws(ws, "Меню");  DrawString( ws, 10,  300,  230, 320, 9, 4, colors[4], GetPaletteAdrByColorIndex( 23 ) );
break;
//------------------------------------------
case 4:
    ...
    DrwPngImg(FImage11, 120-FImage11->w/2, zxinet + 57);  ascii2ws(ws, "Запустить браузер");
    ...
    if (zxn && Setzxn) DrwPngImg(SetIco[5], 0, 171);
     ...
     ascii2ws(ws, "Смотреть видео"); DrawString( ws, 42,  zxinet +212,  229, zxinet +320, 9, 1, colors[7], GetPaletteAdrByColorIndex( 23 ) );
     ascii2ws(ws, "Видео оффлайн на телефоне"); DrawString( ws, 42,  zxinet +226,  229, zxinet +320, 8, 1, colors[8], GetPaletteAdrByColorIndex( 23 ) );
    ...
    ascii2ws(ws, "Интернет"); DrawString( ws, 11,  27,  229, 320, 5, 3, colors[25], GetPaletteAdrByColorIndex( 23 ) );
        ...
        DrawRectangle( 0, 296, 240,320, 1, colors[3], colors[3]);
    ascii2ws(ws, "Обозреватель"); DrawString( ws, 10,  300,  230, 320, 9, 1, colors[4], GetPaletteAdrByColorIndex( 23 ) );
    ascii2ws(ws, "Меню");  DrawString( ws, 10,  300,  230, 320, 9, 4, colors[4], GetPaletteAdrByColorIndex( 23 ) );
break;
//------------------------------------------
case 5:
     ascii2ws(ws, "Фото и видео"); DrawString( ws, 11,  27,  229, 320, 5, 3, colors[25], GetPaletteAdrByColorIndex( 23 ) );


Play6(1,0,0);
//ascii2ws(ws, "Извините, вкладка в процессе доработки и временно закрыта");  DrawString( ws, 10,  145,  230, 320, 8, 3, colors[9], GetPaletteAdrByColorIndex( 23 ) );


         DrawRectangle( 0, 296, 240,320, 1, colors[3], colors[3]);
    ascii2ws(ws, "Видео"); DrawString( ws, 10,  300,  230, 320, 9, 1, colors[4], GetPaletteAdrByColorIndex( 23 ) );
    ascii2ws(ws, "Меню");  DrawString( ws, 10,  300,  230, 320, 9, 4, colors[4], GetPaletteAdrByColorIndex( 23 ) );
break;
//------------------------------------------
case 6:
    ascii2ws(ws, "Музыка"); DrawString( ws, 11,  27,  229, 320, 5, 3, colors[25], GetPaletteAdrByColorIndex( 23 ) );

Play6(1,1,0);
//ascii2ws(ws, "Извините, вкладка в процессе доработки и временно закрыта");  DrawString( ws, 10,  145,  230, 320, 8, 3, colors[9], GetPaletteAdrByColorIndex( 23 ) );

        DrawRectangle( 0, 296, 240,320, 1, colors[3], colors[3]);
    ascii2ws(ws, "Радио"); DrawString( ws, 10,  300,  230, 320, 9, 1, colors[4], GetPaletteAdrByColorIndex( 23 ) );
    ascii2ws(ws, "Меню");  DrawString( ws, 10,  300,  230, 320, 9, 4, colors[4], GetPaletteAdrByColorIndex( 23 ) );
break;
//------------------------------------------
case 7:
     ascii2ws(ws, "Погода"); DrawString( ws, 11,  27,  229, 320, 5, 3, colors[25], GetPaletteAdrByColorIndex( 23 ) );

ascii2ws(ws, "Не обнаружен Weather.elf!");  DrawString( ws, 10,  145,  230, 320, 8, 3, colors[9], GetPaletteAdrByColorIndex( 23 ) );

         DrawRectangle( 0, 296, 240,320, 1, colors[3], colors[3]);
    ascii2ws(ws, "5 дней"); DrawString( ws, 10,  300,  230, 320, 9, 1, colors[4], GetPaletteAdrByColorIndex( 23 ) );
    ascii2ws(ws, "Меню");  DrawString( ws, 10,  300,  230, 320, 9, 4, colors[4], GetPaletteAdrByColorIndex( 23 ) );
break;
//------------------------------------------
case 8:
    ascii2ws(ws, "Настройка"); DrawString( ws, 11,  27,  229, 320, 5, 3, colors[25], GetPaletteAdrByColorIndex( 23 ) );
...
if(SetCursor!=1){coloris7 = colors[7]; coloris8 = colors[8];}
     ...
     ascii2ws(ws, "Система"); DrawString( ws, 42,  62,  229, 320, 9, 1, coloris7, GetPaletteAdrByColorIndex( 23 ) );
     ascii2ws(ws, "Настройки оболочки HTC"); DrawString( ws, 42,  76,  229, 320, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
...
if(SetCursor!=2){coloris7 = colors[7]; coloris8 = colors[8];}
     ...
     ascii2ws(ws, "Звуки"); DrawString( ws, 42,  99,  229, 320, 9, 1, coloris7, GetPaletteAdrByColorIndex( 23 ) );
     ascii2ws(ws, "Звонки и сигналы"); DrawString( ws, 42,  113,  229, 320, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
...
if(SetCursor!=3){coloris7 = colors[7]; coloris8 = colors[8];}
     ...
     ascii2ws(ws, "Графика"); DrawString( ws, 42,  136,  229, 320, 9, 1, coloris7, GetPaletteAdrByColorIndex( 23 ) );
     ascii2ws(ws, "Графика, шрифты и цвета"); DrawString( ws, 42,  150,  229, 320, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
...
if(SetCursor!=4){coloris7 = colors[7]; coloris8 = colors[8];}
     ...
     ascii2ws(ws, "Приложения"); DrawString( ws, 42,  173,  229, 320, 9, 1, coloris7, GetPaletteAdrByColorIndex( 23 ) );
     ascii2ws(ws, "Настройка программ"); DrawString( ws, 42,  187,  229, 320, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
...
if(SetCursor!=5){coloris7 = colors[7]; coloris8 = colors[8];}
     ...
     ascii2ws(ws, "Дополн. настройки"); DrawString( ws, 42,  210,  229, 320, 9, 1, coloris7, GetPaletteAdrByColorIndex( 23 ) );
     ascii2ws(ws, "Не вошедшие в другие"); DrawString( ws, 42,  224,  229, 320, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
...
//------------------------------------------
case 9:
    ascii2ws(ws, "Программы"); DrawString( ws, 11,  27,  229, 320, 5, 3, colors[25], GetPaletteAdrByColorIndex( 23 ) );

ascii2ws(ws, "Нет установленных приложений");  DrawString( ws, 10,  145,  230, 320, 8, 3, colors[9], GetPaletteAdrByColorIndex( 23 ) );


        DrawRectangle( 0, 296, 240,320, 1, colors[3], colors[3]);
    ascii2ws(ws, "Выбрать"); DrawString( ws, 10,  300,  230, 320, 9, 1, colors[4], GetPaletteAdrByColorIndex( 23 ) );
    ascii2ws(ws, "Меню");  DrawString( ws, 10,  300,  230, 320, 9, 4, colors[4], GetPaletteAdrByColorIndex( 23 ) );
break;
//------------------------------------------
case 10:
...
ascii2ws(ws, "Нет установленных приложений");  DrawString( ws, 10,  145,  230, 320, 8, 3, colors[9], GetPaletteAdrByColorIndex( 23 ) );
        ...
        DrawRectangle( 0, 296, 240,320, 1, colors[3], colors[3]);
    ascii2ws(ws, "Телефон"); DrawString( ws, 10,  300,  230, 320, 9, 1, colors[4], GetPaletteAdrByColorIndex( 23 ) );
    ascii2ws(ws, "Меню");  DrawString( ws, 10,  300,  230, 320, 9, 4, colors[4], GetPaletteAdrByColorIndex( 23 ) );
break;
//------------------------------------------
