...
FLIST *AddToFList(const char* full_name, const char *name, int is_folder)
{
  ...
  fn->fullname=(char *)malloc(strlen(full_name)+1);
...
int Play6(int sm0, int numberx, int cursor)
{
	LockSched();
	 WSHDR * ws = AllocWS( 26 );
	FLIST *fl0;
	...
	UnlockSched();
if(fl0){
     if(fl0->name) ascii2ws(ws, fl0->name);                DrawString( ws, 42,  62,  234, 76, 9, 1, colors[7], GetPaletteAdrByColorIndex( 23 ) );
     if(fl0->fullname) ascii2ws(ws, fl0->fullname);        DrawString( ws, 42,  76,  234, 90, 8, 1, colors[8], GetPaletteAdrByColorIndex( 23 ) );
...
if(fl0){
     if(fl0->name) ascii2ws(ws, fl0->name);                DrawString( ws, 42,  99,   234, 113, 9, 1, colors[7], GetPaletteAdrByColorIndex( 23 ) );
     if(fl0->fullname) ascii2ws(ws, fl0->fullname);        DrawString( ws, 42,  113,  234, 127, 8, 1, colors[8], GetPaletteAdrByColorIndex( 23 ) );
...
if(fl0){
     if(fl0->name) ascii2ws(ws, fl0->name);                DrawString( ws, 42,  136,  234, 150, 9, 1, colors[7], GetPaletteAdrByColorIndex( 23 ) );
     if(fl0->fullname) ascii2ws(ws, fl0->fullname);        DrawString( ws, 42,  150,  234, 164, 8, 1, colors[8], GetPaletteAdrByColorIndex( 23 ) );
...
if(fl0){
     if(fl0->name) ascii2ws(ws, fl0->name);                DrawString( ws, 42,  173,  234, 187, 9, 1, colors[7], GetPaletteAdrByColorIndex( 23 ) );
     if(fl0->fullname) ascii2ws(ws, fl0->fullname);        DrawString( ws, 42,  187,  234, 201, 8, 1, colors[8], GetPaletteAdrByColorIndex( 23 ) );
...
if(fl0){
     ...
     if(fl0->name) ascii2ws(ws, fl0->name);                DrawString( ws, 42,  210,  234, 224, 9, 1, colors[7], GetPaletteAdrByColorIndex( 23 ) );
     if(fl0->fullname) ascii2ws(ws, fl0->fullname);        DrawString( ws, 42,  224,  234, 238, 8, 1, colors[8], GetPaletteAdrByColorIndex( 23 ) );
