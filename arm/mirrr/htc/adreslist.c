...
WSHDR * name_call[5];
WSHDR * number_call[5];
WSHDR * number_call1[5];
WSHDR * number_call2[5];
WSHDR * number_call3[5];


extern char *colors[40];
...
if(cursor!=0){coloris7 = colors[7]; coloris8 = colors[8];}
else  {coloris7 = colors[13]; coloris8 = colors[14];}

     if(cl0->name)   DrawString( cl0->name,   37,  62,  229, 76, 9, 1, coloris7, GetPaletteAdrByColorIndex( 23 ) );

     if(cl0->num[0] ) DrawString( cl0->num[0], 37,  76,  229, 90, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
     if(cl0->num[1] && !cl0->num[0] ) DrawString( cl0->num[1], 37,  76,  229, 90, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
     if(!cl0->num[1] && !cl0->num[0]   &&  cl0->num[2] ) DrawString( cl0->num[2], 37,  76,  229, 90, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );


	 number_call[0]=cl0->num[0];
	 number_call1[0]=cl0->num[1];
	 number_call2[0]=cl0->num[2];
	 number_call3[0]=cl0->num[3];
	 name_call[0]=cl0->name;


     DrwPngImg(SetIco[18], 4, 60);
     DrawLine(0,95,239,95,1,colors[16]);
     cl0=(CLIST*)(cl0->next);
	 cmc++;
}
if(cl0){
if(cursor!=1){coloris7 = colors[7]; coloris8 = colors[8];}
else  {coloris7 = colors[13]; coloris8 = colors[14];}
     if(cl0->name)   DrawString( cl0->name,   37,  99,   229, 112, 9, 1, coloris7, GetPaletteAdrByColorIndex( 23 ) );
    if(cl0->num[0] ) DrawString( cl0->num[0], 37,  113,  229, 126, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
    if(cl0->num[1] && !cl0->num[0] )  DrawString( cl0->num[1], 37,  113,  229, 126, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
    if(!cl0->num[1] && !cl0->num[0]   &&  cl0->num[2] )  DrawString( cl0->num[2], 37,  113,  229, 126, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );


	 number_call[1]=cl0->num[0];
	 number_call1[1]=cl0->num[1];
	 number_call2[1]=cl0->num[2];
	 number_call3[1]=cl0->num[3];
	 name_call[1]=cl0->name;

     DrwPngImg(SetIco[18], 4, 97);
     DrawLine(0,132,239,132,1,colors[16]);
     cl0=(CLIST*)(cl0->next);
	 cmc++;
}
if(cl0){
	if(cursor!=2){coloris7 = colors[7]; coloris8 = colors[8];}
else  {coloris7 = colors[13]; coloris8 = colors[14];}
     if(cl0->name)   DrawString( cl0->name,   37,  136,  229, 149, 9, 1, coloris7, GetPaletteAdrByColorIndex( 23 ) );


     if(cl0->num[0] ) DrawString( cl0->num[0], 37,  150,  229, 163, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
      if(cl0->num[1] && !cl0->num[0] ) DrawString( cl0->num[1], 37,  150,  229, 163, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
      if(!cl0->num[1] && !cl0->num[0]   &&  cl0->num[2] ) DrawString( cl0->num[2], 37,  150,  229, 163, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );

	 number_call[2]=cl0->num[0];
	 number_call1[2]=cl0->num[1];
	 number_call2[2]=cl0->num[2];
	 number_call3[2]=cl0->num[3];
	 name_call[2]=cl0->name;

     DrwPngImg(SetIco[18], 4, 134);
     DrawLine(0,169,239,169,1,colors[16]);
     cl0=(CLIST*)(cl0->next);
	 cmc++;
}
if(cl0){
	if(cursor!=3){coloris7 = colors[7]; coloris8 = colors[8];}
else  {coloris7 = colors[13]; coloris8 = colors[14];}
     if(cl0->name)   DrawString( cl0->name,   37,  173,  229, 186, 9, 1, coloris7, GetPaletteAdrByColorIndex( 23 ) );

     if(cl0->num[0] ) DrawString( cl0->num[0], 37,  187,  229, 200, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
     if(cl0->num[1] && !cl0->num[0] ) DrawString( cl0->num[1], 37,  187,  229, 200, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
     if(!cl0->num[1] && !cl0->num[0]   &&  cl0->num[2] ) DrawString( cl0->num[2], 37,  187,  229, 200, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
	 	 number_call[3]=cl0->num[0];
		 number_call1[3]=cl0->num[1];
		 number_call2[3]=cl0->num[2];
		 number_call3[3]=cl0->num[3];
		 name_call[3]=cl0->name;

     DrwPngImg(SetIco[18], 4, 171);
     DrawLine(0,206,239,206,1,colors[16]);
	 cl0=(CLIST*)(cl0->next);
	 cmc++;
}
if(cl0){
	if(cursor!=4){coloris7 = colors[7]; coloris8 = colors[8];}
else  {coloris7 = colors[13]; coloris8 = colors[14];}
     if(cl0->name)   DrawString( cl0->name,   37,  210,  229, 320, 9, 1, coloris7, GetPaletteAdrByColorIndex( 23 ) );

      if(cl0->num[0] ) DrawString( cl0->num[0], 37,  224,  229, 319, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
      if(cl0->num[1] && !cl0->num[0] ) DrawString( cl0->num[1], 37,  224,  229, 319, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );
      if(!cl0->num[1] && !cl0->num[0]   &&  cl0->num[2] ) DrawString( cl0->num[2], 37,  224,  229, 319, 8, 1, coloris8, GetPaletteAdrByColorIndex( 23 ) );

	 	 number_call[4]=cl0->num[0];
	 number_call1[4]=cl0->num[1];
	 number_call2[4]=cl0->num[2];
	 number_call3[4]=cl0->num[3];
	 name_call[4]=cl0->name;
     DrwPngImg(SetIco[18], 4, 208);
  	 cl0=(CLIST*)(cl0->next);
	 cmc++;
}
if(cl0){
...
// 							if (hook_state!=5) goto L_STOP;
		...
		//§¥§à§Ò§Ñ§Ó§Ý§ñ§Ö§Þ §Ó §ã§á§Ú§ã§à§Ü
								int n=0;
								CLIST *p=(CLIST *)malloc(sizeof(contact));
								CLIST *t;
								CLIST *b=(CLIST *)(&cltop);
								contact.next=0;
