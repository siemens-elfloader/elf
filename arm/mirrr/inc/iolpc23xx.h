...
#ifndef __IOLPC23XX_H
#define __IOLPC23XX_H
 ...
 ***************************************************************************
 **
 **    LPC23xx SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(AHBCFG1,               0xE01FC188,__READ_WRITE ,__ahbcfg_bits);
__IO_REG32_BIT(AHBCFG2,               0xE01FC18C,__READ_WRITE ,__ahbcfg_bits);
...
__IO_REG32_BIT(FIO00DIR,              0x3FFFC000,__READ_WRITE ,__gpio0_bits);
__IO_REG32_BIT(FIO0MASK,              0x3FFFC010,__READ_WRITE ,__gpio0_bits);
__IO_REG32_BIT(FIO0PIN,               0x3FFFC014,__READ_WRITE ,__gpio0_bits);
__IO_REG32_BIT(FIO0SET,               0x3FFFC018,__READ_WRITE ,__gpio0_bits);
__IO_REG32_BIT(FIO0CLR,               0x3FFFC01C,__WRITE      ,__gpio0_bits);
__IO_REG32_BIT(FIO10DIR,              0x3FFFC020,__READ_WRITE ,__gpio1_bits);
__IO_REG32_BIT(FIO1MASK,              0x3FFFC030,__READ_WRITE ,__gpio1_bits);
__IO_REG32_BIT(FIO1PIN,               0x3FFFC034,__READ_WRITE ,__gpio1_bits);
__IO_REG32_BIT(FIO1SET,               0x3FFFC038,__READ_WRITE ,__gpio1_bits);
__IO_REG32_BIT(FIO1CLR,               0x3FFFC03C,__WRITE      ,__gpio1_bits);
__IO_REG32_BIT(FIO20DIR,              0x3FFFC040,__READ_WRITE ,__gpio2_bits);
__IO_REG32_BIT(FIO2MASK,              0x3FFFC050,__READ_WRITE ,__gpio2_bits);
__IO_REG32_BIT(FIO2PIN,               0x3FFFC054,__READ_WRITE ,__gpio2_bits);
__IO_REG32_BIT(FIO2SET,               0x3FFFC058,__READ_WRITE ,__gpio2_bits);
__IO_REG32_BIT(FIO2CLR,               0x3FFFC05C,__WRITE      ,__gpio2_bits);
__IO_REG32_BIT(FIO30DIR,              0x3FFFC060,__READ_WRITE ,__gpio3_bits);
__IO_REG32_BIT(FIO3MASK,              0x3FFFC070,__READ_WRITE ,__gpio3_bits);
__IO_REG32_BIT(FIO3PIN,               0x3FFFC074,__READ_WRITE ,__gpio3_bits);
__IO_REG32_BIT(FIO3SET,               0x3FFFC078,__READ_WRITE ,__gpio3_bits);
__IO_REG32_BIT(FIO3CLR,               0x3FFFC07C,__WRITE      ,__gpio3_bits);
__IO_REG32_BIT(FIO40DIR,              0x3FFFC080,__READ_WRITE ,__gpio4_bits);
__IO_REG32_BIT(FIO4MASK,              0x3FFFC090,__READ_WRITE ,__gpio4_bits);
__IO_REG32_BIT(FIO4PIN,               0x3FFFC094,__READ_WRITE ,__gpio4_bits);
__IO_REG32_BIT(FIO4SET,               0x3FFFC098,__READ_WRITE ,__gpio4_bits);
__IO_REG32_BIT(FIO4CLR,               0x3FFFC09C,__WRITE      ,__gpio4_bits);
...
__IO_REG32_BIT(OIntStatus,            0xE0028080,__READ       ,__iointst_bits);
...
__IO_REG32_BIT(RxDescriptor,          0xFFE00108,__READ_WRITE ,__rxdescr_bits);
__IO_REG32_BIT(RxStatus,              0xFFE0010C,__READ_WRITE ,__rxstat_bits);
...
__IO_REG32_BIT(TxDescriptor,          0xFFE0011C,__READ_WRITE ,__txdescr_bits);
__IO_REG32_BIT(TxStatus,              0xFFE00120,__READ_WRITE ,__txstat_bits);
...
__IO_REG32_BIT(RxFliterCtrl,          0xFFE00200,__READ_WRITE ,__rxflctrl_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(OTG_int_status,        0xFFE0C100,__READ       ,__OTG_int_status_bits);
__IO_REG32_BIT(OTG_int_enable,        0xFFE0C104,__READ_WRITE ,__OTG_int_enable_bits);
__IO_REG32_BIT(OTG_int_set,           0xFFE0C108,__WRITE      ,__OTG_int_set_bits);
__IO_REG32_BIT(OTG_int_clear,         0xFFE0C10C,__WRITE      ,__OTG_int_clr_bits);
__IO_REG32_BIT(OTG_stat_ctrl,         0xFFE0C110,__READ_WRITE ,__OTG_stat_ctrl_bits);
...
__IO_REG32_BIT(I2C_STS,               0xFFE0C304,__READ       ,__otg_i2c_sts_bits);
...
__IO_REG32_BIT(OTG_clock_control,     0xFFE0CFF4,__READ_WRITE ,__OTG_clock_bits);
__IO_REG32_BIT(OTG_clock_status,      0xFFE0CFF8,__READ       ,__OTG_clock_bits);
...
__IO_REG32(    MCIResponse4,          0xE008C020,__READ);
...
__IO_REG32_BIT(I2C2SCLH,              0xE0080010,__READ_WRITE ,__i2scl_bits);
...
#define VIC_CAN01       23  /* CAN0,1 Tx, Rx                      */
