...
__IO_REG16(    ENET_RXTOR,          0x7C000028,__READ      );
...
__IO_REG16(    ENET_TXTOR,          0x7C000048,__READ      );
...
__IO_REG16(    ENET_MAH,            0x7C000404,__READ_WRITE);
__IO_REG16(    ENET_MAL,            0x7C000408,__READ_WRITE);
...
__IO_REG16(    ENET_MIID,           0x7C000418,__READ_WRITE);
...
__IO_REG16(    ENET_RXTOR_BUF,      0x6C000028,__READ      );
...
__IO_REG16(    ENET_TXTOR_BUF,      0x6C000048,__READ      );
...
__IO_REG16(    ENET_MAH_BUF,        0x6C000404,__READ_WRITE);
__IO_REG16(    ENET_MAL_BUF,        0x6C000408,__READ_WRITE);
...
__IO_REG16(    ENET_MIID_BUF,       0x6C000418,__READ_WRITE);
