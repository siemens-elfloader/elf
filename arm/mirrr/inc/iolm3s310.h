...
/* PWM0 Interrupt/Trigger Enable (PWMINTEN)
   ...
   PWM0 Interrupt Status and Clear (PWMISC) */
typedef struct {
...
__IO_REG32_BIT(PWM0RIS,           0x40028048,__READ       ,__pwm0inten_bits);
__IO_REG32_BIT(PWM0ISC,           0x4002804C,__READ_WRITE ,__pwm0inten_bits);
...
__IO_REG32_BIT(PWM2RIS,           0x400280C8,__READ       ,__pwm0inten_bits);
__IO_REG32_BIT(PWM2ISC,           0x400280CC,__READ_WRITE ,__pwm0inten_bits);
__IO_REG16(    PWM2LOAD,          0x400280D0,__READ_WRITE);
__IO_REG16(    PWM2COUNT,         0x400280D4,__READ);
__IO_REG16(    PWM2CMPA,          0x400280D8,__READ_WRITE);
__IO_REG16(    PWM2CMPB,          0x400280DC,__READ_WRITE);
__IO_REG32_BIT(PWM2GENA,          0x400280E0,__READ_WRITE ,__pwm0gen_bits);
__IO_REG32_BIT(PWM2GENB,          0x400280E4,__READ_WRITE ,__pwm0gen_bits);
...
/***************************************************************************
 **
 **  LM3S310 Bit in Interrupt Registers
 **
 ***************************************************************************/
#define NVIC_GPIOA             0
#define NVIC_GPIOB             1
