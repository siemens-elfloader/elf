...
__IO_REG32(    SCC2CANME,   0xfff7e100,__READ_WRITE);
__IO_REG32(    SCC2CANMD,   0xfff7e104,__READ_WRITE);
__IO_REG32(    SCC2CANTRS,  0xfff7e108,__READ_WRITE);
__IO_REG32(    SCC2CANTRR,  0xfff7e10c,__READ_WRITE);
__IO_REG32(    SCC2CANTA,   0xfff7e110,__READ_WRITE);
__IO_REG32(    SCC2CANAA,   0xfff7e114,__READ_WRITE);
__IO_REG32(    SCC2CANRMP,  0xfff7e118,__READ_WRITE);
__IO_REG32(    SCC2CANRML,  0xfff7e11c,__READ_WRITE);
__IO_REG32(    SCC2CANRFP,  0xfff7e120,__READ_WRITE);
__IO_REG32_BIT(SCC2CANGAM,  0xfff7e124,__READ_WRITE,__cangam_bits);
__IO_REG32_BIT(SCC2CANMC,   0xfff7e128,__READ_WRITE,__canmc_bits);
__IO_REG32_BIT(SCC2CANBTC,  0xfff7e12c,__READ_WRITE,__canbtc_bits);
__IO_REG32_BIT(SCC2CANES,   0xfff7e130,__READ_WRITE,__canes_bits);
__IO_REG32_BIT(SCC2CANTEC,  0xfff7e134,__READ_WRITE,__cantec_bits);
__IO_REG32_BIT(SCC2CANREC,  0xfff7e138,__READ_WRITE,__canrec_bits);
__IO_REG32_BIT(SCC2CANGIF0, 0xfff7e13c,__READ_WRITE,__cangif_bits);
__IO_REG32_BIT(SCC2CANGIM,  0xfff7e140,__READ_WRITE,__cangim_bits);
__IO_REG32_BIT(SCC2CANGIF1, 0xfff7e144,__READ_WRITE,__cangif_bits);
__IO_REG32(    SCC2CANMIM,  0xfff7e148,__READ_WRITE);
__IO_REG32(    SCC2CANMIL,  0xfff7e14c,__READ_WRITE);
__IO_REG32(    SCC2CANOPC,  0xfff7e150,__READ_WRITE);
__IO_REG32_BIT(SCC2CANTIOC, 0xfff7e154,__READ_WRITE,__cantioc_bits);
__IO_REG32_BIT(SCC2CANRIOC, 0xfff7e158,__READ_WRITE,__canrioc_bits);
