...
__IO_REG32_BIT(BLKSRCSTRT,          0x80040008,__READ_WRITE,__blksrcstrt_bits);
__IO_REG32_BIT(BLKDESTSTRT,         0x8004000c,__READ_WRITE,__blkdeststrt_bits);
