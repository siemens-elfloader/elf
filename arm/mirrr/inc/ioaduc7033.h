...
__IO_REG32(T4VAL, 0xFFFF0384,__READ_WRITE);
__IO_REG32(T4CON, 0xFFFF0388,__READ_WRITE);
__IO_REG32(T4CLRI, 0xFFFF038C,__READ_WRITE);
...
__IO_REG32(STIKEY1, 0xFFFF0888,__READ_WRITE);
