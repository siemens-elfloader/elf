...
// (DO NOT EDIT: machine generated header) 'ETblFldLinks.pas' rev: 6.00

#ifndef ETblFldLinksHPP
#define ETblFldLinksHPP
...
//-- var, const, procedure ---------------------------------------------------
#define SMissingDataSource "Missing MasterSource or DataSource."
#define SLinkDesigner "Field %s, from the Detail Fields list, must be linked"
extern PACKAGE bool __fastcall EditMasterFields(Db::TDataSet* ADataSet, TFieldLinkProperty* ADataSetProxy);

}	/* namespace Etblfldlinks */
using namespace Etblfldlinks;
#pragma option pop	// -w-
