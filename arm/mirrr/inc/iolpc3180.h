...
__IO_REG8_BIT( MLC_IRQ_MR,            0x200B8038,__WRITE     ,__mlc_irq_bits);
__IO_REG8_BIT( MLC_IRQ_SR,            0x200B803C,__READ      ,__mlc_irq_bits);
__IO_REG16(    MLC_LOCK_PR,           0x200B8044,__WRITE     );
__IO_REG8_BIT( MLC_ISR,               0x200B8048,__READ      ,__mlc_isr_bits);
 ...
 **
 ***************************************************************************/
__IO_REG16_BIT(SLC_DATA,              0x20020000,__READ_WRITE,__slc_data_bits);
__IO_REG8(     SLC_ADDR,              0x20020004,__WRITE     );
__IO_REG8(     SLC_CMD,               0x20020008,__WRITE     );
__IO_REG8(     SLC_STOP,              0x2002000C,__WRITE     );
...
__IO_REG16(    SLC_TC,                0x20020030,__READ_WRITE);
...
__IO_REG8_BIT( DEVINTPRI,             0x3102022C,__WRITE     ,__devintpri_bits);
...
__IO_REG16(    OTG_timer,             0x31020114,__READ_WRITE);
...
__IO_REG8(     I2C_CLKHI,             0x3102030C,__READ_WRITE);
__IO_REG8(     I2C_CLKLO,             0x31020310,__READ_WRITE);
...
__IO_REG8(     U3RBRTHR,              0x40080000,__READ_WRITE);
#define U3DLL U3RBRTHR
#define U3RBR U3RBRTHR
#define U3THR U3RBRTHR

/* U3DLM and U3IER share the same address */
__IO_REG8_BIT( U3IER,                 0x40080004,__READ_WRITE,__uartier_bits);
#define U3DLM U3IER

/* U3FCR and U3IIR share the same address */
__IO_REG8_BIT( U3FCR,                 0x40080008,__READ_WRITE,__uartfcriir_bits);
#define U3IIR      U3FCR
#define U3IIR_bit  U3FCR_bit

__IO_REG8_BIT( U3LCR,                 0x4008000C,__READ_WRITE,__uartlcr_bits);
__IO_REG8_BIT( U3LSR,                 0x40080014,__READ      ,__uartlsr_bits);
__IO_REG8_BIT( U3RXLEV,               0x4008001C,__READ      ,__uartrexlev_bits);
...
__IO_REG8(     U4RBRTHR,              0x40088000,__READ_WRITE);
#define U4DLL U4RBRTHR
#define U4RBR U4RBRTHR
#define U4THR U4RBRTHR

/* U4DLM and U4IER share the same address */
__IO_REG8_BIT( U4IER,                 0x40088004,__READ_WRITE,__uartier_bits);
#define U4DLM U4IER

/* U4FCR and U4IIR share the same address */
__IO_REG8_BIT( U4FCR,                 0x40088008,__READ_WRITE,__uartfcriir_bits);
#define U4IIR      U4FCR
#define U4IIR_bit  U4FCR_bit

__IO_REG8_BIT( U4LCR,                 0x4008800C,__READ_WRITE,__uartlcr_bits);
__IO_REG8_BIT( U4LSR,                 0x40088014,__READ      ,__uartlsr_bits);
__IO_REG8_BIT( U4RXLEV,               0x4008801C,__READ      ,__uartrexlev_bits);
...
__IO_REG8(     U5RBRTHR,              0x40090000,__READ_WRITE);
#define U5DLL U5RBRTHR
#define U5RBR U5RBRTHR
#define U5THR U5RBRTHR

/* U5DLM and U5IER share the same address */
__IO_REG8_BIT( U5IER,                 0x40090004,__READ_WRITE,__uartier_bits);
#define U5DLM U5IER

/* U5FCR and U5IIR share the same address */
__IO_REG8_BIT( U5FCR,                 0x40090008,__READ_WRITE,__uartfcriir_bits);
#define U5IIR      U5FCR
#define U5IIR_bit  U5FCR_bit

__IO_REG8_BIT( U5LCR,                 0x4009000C,__READ_WRITE,__uartlcr_bits);
__IO_REG8_BIT( U5LSR,                 0x40090014,__READ      ,__uartlsr_bits);
__IO_REG8_BIT( U5RXLEV,               0x4009001C,__READ      ,__uartrexlev_bits);
...
__IO_REG8(     U6RBRTHR,              0x40098000,__READ_WRITE);
#define U6DLL U6RBRTHR
#define U6RBR U6RBRTHR
#define U6THR U6RBRTHR

/* U6DLM and U6IER share the same address */
__IO_REG8_BIT( U6IER,                 0x40098004,__READ_WRITE,__uartier_bits);
#define U6DLM U5IER

/* U5FCR and U5IIR share the same address */
__IO_REG8_BIT( U6FCR,                 0x40098008,__READ_WRITE,__uartfcriir_bits);
#define U6IIR      U6FCR
#define U6IIR_bit  U6FCR_bit

__IO_REG8_BIT( U6LCR,                 0x4009800C,__READ_WRITE,__uartlcr_bits);
__IO_REG8_BIT( U6LSR,                 0x40098014,__READ      ,__uartlsr_bits);
__IO_REG8_BIT( U6RXLEV,               0x4009801C,__READ      ,__uartrexlev_bits);
...
__IO_REG8_BIT( HSU1_IIR,              0x40014008,__READ_WRITE,__hsu_iir_bits);
__IO_REG32_BIT(HSU1_CTRL,             0x4001400C,__READ_WRITE,__hsu_ctrl_bits);
__IO_REG8(     HSU1_RATE,             0x40014010,__READ_WRITE);
...
__IO_REG8_BIT( HSU2_IIR,              0x40018008,__READ_WRITE,__hsu_iir_bits);
__IO_REG32_BIT(HSU2_CTRL,             0x4001800C,__READ_WRITE,__hsu_ctrl_bits);
__IO_REG8(     HSU2_RATE,             0x40018010,__READ_WRITE);
...
__IO_REG8_BIT( HSU7_IIR,              0x4001C008,__READ_WRITE,__hsu_iir_bits);
__IO_REG32_BIT(HSU7_CTRL,             0x4001C00C,__READ_WRITE,__hsu_ctrl_bits);
__IO_REG8(     HSU7_RATE,             0x4001C010,__READ_WRITE);
...
__IO_REG16(    SPI1_FRM,              0x20088008,__READ_WRITE);
...
__IO_REG16(    SPI1_DAT,              0x20088014,__READ_WRITE);
__IO_REG32_BIT(SPI1_TIM_CTRL,         0x20088400,__READ_WRITE,__spi_tim_ctrl_bits);
__IO_REG16(    SPI1_TIM_COUNT,        0x20088404,__READ_WRITE);
...
__IO_REG16(    SPI2_FRM,              0x20090008,__READ_WRITE);
...
__IO_REG16(    SPI2_DAT,              0x20090014,__READ_WRITE);
__IO_REG32_BIT(SPI2_TIM_CTRL,         0x20090400,__READ_WRITE,__spi_tim_ctrl_bits);
__IO_REG16(    SPI2_TIM_COUNT,        0x20090404,__READ_WRITE);
...
__IO_REG16(    SD_DataLength,         0x20098028,__READ_WRITE);
__IO_REG32_BIT(SD_DataCtrl,           0x2009802C,__READ_WRITE,__SD_DataCtrl_bits);
__IO_REG16(    SD_DataCnt,            0x20098030,__READ      );
 ...
 **
 ***************************************************************************/
__IO_REG8(     KS_DEB,                0x40050000,__READ_WRITE);
__IO_REG8_BIT( KS_STATE_COND,         0x40050004,__READ      ,__ks_state_cond_bits);
__IO_REG8_BIT( KS_IRQ,                0x40050008,__READ_WRITE,__ks_irq_bits);
__IO_REG8(     KS_SCAN_CTL,           0x4005000C,__READ_WRITE);
__IO_REG8_BIT( KS_FAST_TST,           0x40050010,__READ_WRITE,__ks_fast_tst_bits);
__IO_REG8_BIT( KS_MATRIX_DIM,         0x40050014,__READ_WRITE,__ks_matrix_dim_bits);
__IO_REG8(     KS_DATA0,              0x40050040,__READ      );
__IO_REG8(     KS_DATA1,              0x40050044,__READ      );
__IO_REG8(     KS_DATA2,              0x40050048,__READ      );
__IO_REG8(     KS_DATA3,              0x4005004C,__READ      );
__IO_REG8(     KS_DATA4,              0x40050050,__READ      );
__IO_REG8(     KS_DATA5,              0x40050054,__READ      );
__IO_REG8(     KS_DATA6,              0x40050058,__READ      );
__IO_REG8(     KS_DATA7,              0x4005005C,__READ      );
...
__IO_REG16(    HSTIM_PMATCH,          0x4003800C,__READ_WRITE);
__IO_REG16(    HSTIM_PCOUNT,          0x40038010,__READ_WRITE);
...
__IO_REG16(    WDTIM_PULSE,           0x4003C018,__READ_WRITE);
...
__IO_REG8(     DMACPeriphID0,         0xFFE04FE0,__READ      );
__IO_REG8_BIT( DMACPeriphID1,         0xFFE04FE4,__READ      ,__dma_id1_bits);
__IO_REG8_BIT( DMACPeriphID2,         0xFFE04FE8,__READ      ,__dma_id2_bits);
__IO_REG8_BIT( DMACPeriphID3,         0xFFE04FEC,__READ      ,__dma_id3_bits);
