...
__IO_REG32_BIT(FIODIR,          0x3FFFC000,__READ_WRITE,__gpio_bits);
__IO_REG32_BIT(FIOMASK,         0x3FFFC010,__READ_WRITE,__gpio_bits);
__IO_REG32_BIT(FIOPIN,          0x3FFFC014,__READ_WRITE,__gpio_bits);
__IO_REG32_BIT(FIOSET,          0x3FFFC018,__READ_WRITE,__gpio_bits);
__IO_REG32_BIT(FIOCLR,          0x3FFFC01C,__WRITE     ,__gpio_bits);
