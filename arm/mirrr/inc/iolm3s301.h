...
/* ADC Sample Sequence Result FIFO x (ADCSSFIFOx) */
typedef struct {
  __REG32  DATA           :10;
  __REG32                 :22;
} __adcssfifo_bits;

/* ADC Sample Sequence FIFO x Status (ADCSSFSTATx) */
typedef struct {
  __REG32  TPTR           : 4;
  __REG32  HPTR           : 4;
  __REG32  EMPTY          : 1;
...
/* PWM0 Interrupt/Trigger Enable (PWM0INTEN) */
typedef struct {
...
__IO_REG32_BIT(WDTTEST,           0x40000018,__READ_WRITE ,__wdttest_bits);
...
__IO_REG32_BIT(ADCSSFIFO0,        0x40038048,__READ       ,__adcssfifo_bits);
__IO_REG32_BIT(ADCSSFSTAT0,       0x4003804C,__READ       ,__adcssfstat_bits);
...
__IO_REG32_BIT(ADCSSFIFO1,        0x40038068,__READ       ,__adcssfifo_bits);
__IO_REG32_BIT(ADCSSFSTAT1,       0x4003806C,__READ       ,__adcssfstat_bits);
__IO_REG32_BIT(ADCSSMUX2,         0x40038080,__READ_WRITE ,__adcssmux1_bits);
__IO_REG32_BIT(ADCSSCTL2,         0x40038084,__READ_WRITE ,__adcssctl1_bits);
__IO_REG32_BIT(ADCSSFIFO2,        0x40038088,__READ       ,__adcssfifo_bits);
__IO_REG32_BIT(ADCSSFSTAT2,       0x4003808C,__READ       ,__adcssfstat_bits);
...
__IO_REG32_BIT(ADCSSFIFO3,        0x400380A8,__READ       ,__adcssfifo_bits);
__IO_REG32_BIT(ADCSSFSTAT3,       0x400380AC,__READ       ,__adcssfstat_bits);
 ...
 **
 ***************************************************************************/
__IO_REG32_BIT(UARTDR,            0x4000C000,__READ_WRITE ,__uartdr_bits);
__IO_REG32_BIT(UARTRSR,           0x4000C004,__READ_WRITE ,__uartrsr_bits);
#define UARTECR         UARTRSR
#define UARTECR_bit     UARTRSR_bit
__IO_REG32_BIT(UARTFR,            0x4000C018,__READ       ,__uartfr_bits);
__IO_REG16(    UARTIBRD,          0x4000C024,__READ_WRITE);
__IO_REG32_BIT(UARTFBRD,          0x4000C028,__READ_WRITE ,__uartfbrd_bits);
__IO_REG32_BIT(UARTLCRH,          0x4000C02C,__READ_WRITE ,__uartlcrh_bits);
__IO_REG32_BIT(UARTCTL,           0x4000C030,__READ_WRITE ,__uartctl_bits);
__IO_REG32_BIT(UARTIFLS,          0x4000C034,__READ_WRITE ,__uartifls_bits);
__IO_REG32_BIT(UARTIM,            0x4000C038,__READ_WRITE ,__uartim_bits);
__IO_REG32_BIT(UARTRIS,           0x4000C03C,__READ       ,__uartris_bits);
__IO_REG32_BIT(UARTMIS,           0x4000C040,__READ       ,__uartmis_bits);
__IO_REG32_BIT(UARTICR,           0x4000C044,__WRITE 			,__uarticr_bits);
__IO_REG8(     UARTPERIPHID4,     0x4000CFD0,__READ);
__IO_REG8(     UARTPERIPHID5,     0x4000CFD4,__READ);
__IO_REG8(     UARTPERIPHID6,     0x4000CFD8,__READ);
__IO_REG8(     UARTPERIPHID7,     0x4000CFDC,__READ);
__IO_REG8(     UARTPERIPHID0,     0x4000CFE0,__READ);
__IO_REG8(     UARTPERIPHID1,     0x4000CFE4,__READ);
__IO_REG8(     UARTPERIPHID2,     0x4000CFE8,__READ);
__IO_REG8(     UARTPERIPHID3,     0x4000CFEC,__READ);
__IO_REG8(     UARTPCELLID0,      0x4000CFF0,__READ);
__IO_REG8(     UARTPCELLID1,      0x4000CFF4,__READ);
__IO_REG8(     UARTPCELLID2,      0x4000CFF8,__READ);
__IO_REG8(     UARTPCELLID3,      0x4000CFFC,__READ);
...
__IO_REG32_BIT(PWMRIS,            0x40028018,__READ       ,__pwminten_bits);
__IO_REG32_BIT(PWMISC,            0x4002801C,__READ_WRITE ,__pwminten_bits);
...
__IO_REG32_BIT(PWM0ISC,           0x4002804C,__READ_WRITE ,__pwm0ris_bits);
__IO_REG16(    PWM0LOAD,          0x40028050,__READ_WRITE);
__IO_REG16(    PWM0COUNT,         0x40028054,__READ);
__IO_REG16(    PWM0CMPA,          0x40028058,__READ_WRITE);
__IO_REG16(    PWM0CMPB,          0x4002805C,__READ_WRITE);
__IO_REG32_BIT(PWM0GENA,          0x40028060,__READ_WRITE ,__pwm0gen_bits);
__IO_REG32_BIT(PWM0GENB,          0x40028064,__READ_WRITE ,__pwm0gen_bits);
...
/***************************************************************************
 **
 **  LM3S301 Bit in Interrupt Registers
 **
 ***************************************************************************/
#define NVIC_GPIOA             0
#define NVIC_GPIOB             1
...
#define NVIC_ANAL_COMP0       25
#define NVIC_ANAL_COMP1       26
#define NVIC_SYS_CTRL         28
#define NVIC_FLASH_CTRL       29
