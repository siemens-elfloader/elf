...
__IO_REG32(    CAN2ME,   0xfff7e200,__READ_WRITE);
__IO_REG32(    CAN2MD,   0xfff7e204,__READ_WRITE);
__IO_REG32(    CAN2TRS,  0xfff7e208,__READ_WRITE);
__IO_REG32(    CAN2TRR,  0xfff7e20c,__READ_WRITE);
__IO_REG32(    CAN2TA,   0xfff7e210,__READ_WRITE);
__IO_REG32(    CAN2AA,   0xfff7e214,__READ_WRITE);
__IO_REG32(    CAN2RMP,  0xfff7e218,__READ_WRITE);
__IO_REG32(    CAN2RML,  0xfff7e21c,__READ_WRITE);
__IO_REG32(    CAN2RFP,  0xfff7e220,__READ_WRITE);
__IO_REG32_BIT(CAN2GAM,  0xfff7e224,__READ_WRITE,__cangam_bits);
__IO_REG32_BIT(CAN2MC,   0xfff7e228,__READ_WRITE,__canmc_bits);
__IO_REG32_BIT(CAN2BTC,  0xfff7e22c,__READ_WRITE,__canbtc_bits);
__IO_REG32_BIT(CAN2ES,   0xfff7e230,__READ_WRITE,__canes_bits);
__IO_REG32_BIT(CAN2TEC,  0xfff7e234,__READ_WRITE,__cantec_bits);
__IO_REG32_BIT(CAN2REC,  0xfff7e238,__READ_WRITE,__canrec_bits);
__IO_REG32_BIT(CAN2GIF0, 0xfff7e23c,__READ_WRITE,__cangif_bits);
__IO_REG32_BIT(CAN2GIM,  0xfff7e240,__READ_WRITE,__cangim_bits);
__IO_REG32_BIT(CAN2GIF1, 0xfff7e244,__READ_WRITE,__cangif_bits);
__IO_REG32(    CAN2MIM,  0xfff7e248,__READ_WRITE);
__IO_REG32(    CAN2MIL,  0xfff7e24c,__READ_WRITE);
__IO_REG32(    CAN2OPC,  0xfff7e250,__READ_WRITE);
__IO_REG32_BIT(CAN2TIOC, 0xfff7e254,__READ_WRITE,__cantioc_bits);
__IO_REG32_BIT(CAN2RIOC, 0xfff7e258,__READ_WRITE,__canrioc_bits);
