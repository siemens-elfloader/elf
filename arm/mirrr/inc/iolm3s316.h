...
/* PWM0 Interrupt/Trigger Enable (PWMINTEN) */
typedef struct {
...
/* PWM0 Interrupt Status and Clear (PWM0RIS) 
   PWM0 Raw Interrupt Status (PWMRIS) */
typedef struct {
  __REG32  INTCNTZERO     : 1;
  __REG32  INTCNTLOAD     : 1;
  __REG32  INTCMPAU       : 1;
...
__IO_REG32_BIT(PWM1RIS,           0x40028088,__READ       ,__pwm0inten_bits);
__IO_REG32_BIT(PWM1ISC,           0x4002808C,__READ_WRITE ,__pwm0inten_bits);
__IO_REG16(    PWM1LOAD,          0x40028090,__READ_WRITE);
__IO_REG16(    PWM1COUNT,         0x40028094,__READ);
__IO_REG16(    PWM1CMPA,          0x40028098,__READ_WRITE);
__IO_REG16(    PWM1CMPB,          0x4002809C,__READ_WRITE);
__IO_REG32_BIT(PWM1GENA,          0x400280A0,__READ_WRITE ,__pwm0gen_bits);
__IO_REG32_BIT(PWM1GENB,          0x400280A4,__READ_WRITE ,__pwm0gen_bits);
...
/***************************************************************************
 **
 **  LM3S316 Bit in Interrupt Registers
 **
 ***************************************************************************/
#define NVIC_GPIOA             0
#define NVIC_GPIOB             1
