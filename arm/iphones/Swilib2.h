...
{
  int one;
  int (*onKey)(GUI2 *gui, GUI_MSG *msg);
  void (*global_hook_proc)(GUI2 *gui, int cmd);
  void *locret;
  int zero1;
  SOFTKEYSTAB *softkeystab;
  RECT2 rc;
...
//__swi __arm void PlayFile(int _C,WSHDR* folder,WSHDR* filename,int cepid, int _167);
//__swi __arm void PlayFile(int _C,WSHDR* folder,WSHDR* filename,int n0, int _167);errrrr
