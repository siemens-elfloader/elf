...
void stat_info_ghook(GUI *gui, int cmd)
{
  ...
  if (cmd==7 && !EDIT_IsMarkModeActive(gui))
  {
  ...
  wsprintf(ws_stat_info,percent_i, sendq_l);
    EDIT_SetTextToEditControl(gui, 15, ws_stat_info); 
  }
...
HEADER_DESC stat_info_hdr={0,0,0,0,0,0,0x7FFFFFFF};
...
void Disp_stat_Info(void)
{
  ...
  ConstructEditControl(&ec,0,0,ws_stat_info,256);
  AddEditControlToEditQend(eq,&ec,ma); 

  ascii2ws(ws_stat_info,"Состояние:");
  ConstructEditControl(&ec,1,0,ws_stat_info,256);
  AddEditControlToEditQend(eq,&ec,ma);
  wsprintf(ws_stat_info,percent_i, Jabber_state);
  ConstructEditControl(&ec,3,0x40,ws_stat_info,256);
  AddEditControlToEditQend(eq,&ec,ma);
  ...
  ConstructEditControl(&ec,1,0x40,ws_stat_info,256);
  AddEditControlToEditQend(eq,&ec,ma);
  wsprintf(ws_stat_info,percent_i, in_bytes_count);
  ConstructEditControl(&ec,3,0x40,ws_stat_info,256);
  AddEditControlToEditQend(eq,&ec,ma);
  ...
  ConstructEditControl(&ec,3,0,ws_stat_info,256);
  AddEditControlToEditQend(eq,&ec,ma);
