...
__root const CFG_HDR cfghdr1={16,"Пароль",0,31};
...
__root const CFG_HDR cfghdrshowii={11, "Показывать значок на idle", 0, 2};
...
__root const CFG_HDR cfghdr18001={11,"Отображать вход\\выход в MUC",0,2};
__root const int SHOWSTAT_MUCINOUT=1;

__root const CFG_HDR cfghdr18002={11,"Показывать смену статусов в MUC",0,2};
__root const int SHOWSTAT_MUCCHANGESTAT=1;

__root const CFG_HDR cfghdr18003={11,"Выделять сообщения с Вашим ником",0,2};
__root const int BOLD_NICK_INMUC=0;

__root const CFG_HDR cfghdr18004={11,"Доп.инфо в версии клиента",0,2};
...
__root const CFG_HDR cfghdr25={10,"Онлайн",0,255};
__root const char DEFTEX_ONLINE[256]="Online";

__root const CFG_HDR cfghdr26={10,"Готов болтать",0,255};
__root const char DEFTEX_CHAT[256]="Chat";

__root const CFG_HDR cfghdr27={10,"Отсутствую",0,255};
__root const char DEFTEX_AWAY[256]="Away";

__root const CFG_HDR cfghdr28={10,"Недоступен",0,255};
__root const char DEFTEX_XA[256]="Xa";

__root const CFG_HDR cfghdr29={10,"Занят",0,255};
__root const char DEFTEX_DND[256]="DND";

__root const CFG_HDR cfghdr30={10,"Инвиз",0,255};
__root const char DEFTEX_INVISIBLE[256]="Invisible";

__root const CFG_HDR cfghdr31={10,"Оффлайн",0,255};
__root const char DEFTEX_OFFLINE[256]="Offline";

__root const CFG_HDR cfghdr142={10,"MUC offline",0,255};
...
__root const CFG_HDR cfghdr42={10, "Текст", 0, 255};
