...
void AboutDlg(GUI *data)
{
  ...
  snprintf(msg,l,msg_tpl, VERSION_VERS, 2774, "Feb 15 2011");
  ShowMSG(0,(int)msg);
  mfree(msg);
};
...
static const char * const menutexts[16]=
{
  "Контакт",
  "Статус",
  "Конференция",
...
static const MENUPROCS_DESC menuprocs[16]={
                          Disp_Contact_Menu,
...
void MM_Show()
{
  ...
  MainMenu_ID = CreateMenu(0,0,&tmenu,&menuhdr,0,16,0,0);
}
