...
const char CMP_DATE[] = "Feb 15 2011";
...
int writefile(char *color_PATH, char *colorshem_PATH, char *buf)
{
 ...
 strcat(path, colorshem_PATH);
  ...
  f=fopen(path,1+0x8000+0x100,0x100,&err);
 fs.size=40;
  ...
  MAIN_CSM *csm=(MAIN_CSM*)data;
  {
    ...
    if (msg->msg==0xDEB0)
    {
      ...
      if ((ipc=(IPC_REQ*)msg->data0))
      {
        ...
        {
          if ((stricmp(ipc->name_to,"Grantee")==0)&&(Jabber_state == JS_ONLINE))
          {
          extern ONLINEINFO OnlineInfo;
          ...
          FreeWS(ws2);
          msg[len]='\0';
          pr_info->message= msg ==0 ? 0 : Mask_Special_Syms(msg);
          } else
          {
            pr_info->message= 0;
          }
