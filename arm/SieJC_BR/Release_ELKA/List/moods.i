...
HEADER_DESC moodt_hdr={0,0,0,0,0,(int)"Текст настроения",0x7FFFFFFF};
...
void ShowMoodTextDialog(char *mood)
{
  ...
  CreateInputTextDialog(&moodt_desc,&moodt_hdr,eq,1,0);
}
...
HEADER_DESC moods_menuhdr={0,0,131,21,0,(int)"Настроения",0x7FFFFFFF};
...
void Show_Moods_Menu()
{
  ...
  CreateMenu(0,0,&moods_menu,&moods_menuhdr,0,62,0,0);
}
