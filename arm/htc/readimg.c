  ...
  while (cinfo.output_scanline < img_h) 
  {
    ...
    for (int x=0; x<img_w; x++)
    {
      unsigned long long c;
       if (mod==0) c= (char255*0x1000000) + ((row[x*3+0])*0x10000) + ((row[x*3+1])*0x100) + ((row[x*3+2]));
       if (mod==1) c= (char255*0x1000000) + ((255-row[x*3+0])*0x10000) + ((255-row[x*3+1])*0x100) + ((255-row[x*3+2]));
      *iimg++=c;
