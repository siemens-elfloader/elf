...
CSM_DESC icsmd;
int ker_state;
extern const char info[4];
extern const char title[4];

int r_s=20;
int r_m;
int r_h;
IMGHDR *img1, *img2, *img3;
//int r_d;
...
case 2:
  {
    ...
    if(pos_link_x<40)
    {
      pos_link_x=pos_link_x+2;
      if(pos_msg_x!=51) pos_msg_x=pos_msg_x-16;
      DirectRedrawGUI();
    }
    else
      if(pos_msg_x!=51)
      {
        pos_msg_x=pos_msg_x-16;
        DirectRedrawGUI();
      }
    else
    {
...
case 4:
  {
    ...
    {
      pos_link_y=pos_main_y-22+(pos*40);
      pos_msg_y=pos_link_y-56;
      phase=2;
    }
    DirectRedrawGUI();
    GBS_StartTimerProc(&mytmr, 3, DoShowIt);
...
void DrawWeatherLog()
{
  ...
  DrawString(ws,pos_msg_x+5,pos_msg_y+8,pos_msg_x+Get_WS_width(ws,9)+5,pos_msg_y+GetFontYSIZE(9)+8,9,0,title,GetPaletteAdrByColorIndex(23));
  if(engade_weather)
  {
    wsprintf(ws, "On: %s", weather_time);
    DrawString(ws,pos_msg_x+5,pos_msg_y+35,pos_msg_x+Get_WS_width(ws,9)+5,pos_msg_y+GetFontYSIZE(9)+35,9,0,info,GetPaletteAdrByColorIndex(23));
    ascii2ws(ws, temp2);
    DrawString(ws,pos_msg_x+5,pos_msg_y+53,pos_msg_x+Get_WS_width(ws,9)+5,pos_msg_y+GetFontYSIZE(9)+53,9,0,info,GetPaletteAdrByColorIndex(23));
    ascii2ws(ws, vejsh2);
    //wsprintf(ws, vejsh2);
    DrawString(ws,pos_msg_x+5,pos_msg_y+71,pos_msg_x+Get_WS_width(ws,9)+5,pos_msg_y+GetFontYSIZE(9)+71,9,0,info,GetPaletteAdrByColorIndex(23));
    ascii2ws(ws, pressure2);
   // wsprintf(ws, pressure2);
    DrawString(ws,pos_msg_x+5,pos_msg_y+89,pos_msg_x+Get_WS_width(ws,9)+5,pos_msg_y+GetFontYSIZE(9)+89,9,0,info,GetPaletteAdrByColorIndex(23));
  }
  else
  {
...
void DrawWeatherLog()
{
  WSHDR *ws=AllocWS(64);
  wsprintf(ws, "[%t: %t]", LG_WET, city_name);
  DrawString(ws,pos_msg_x+3,pos_msg_y+3,pos_msg_x+Get_WS_width(ws,font)+3,pos_msg_y+GetFontYSIZE(font)+3,font,0,title,GetPaletteAdrByColorIndex(23));
  if(engade_weather)
  {
    wsprintf(ws, "On: %s", weather_time);
    DrawString(ws,pos_msg_x+3,pos_msg_y+25,pos_msg_x+Get_WS_width(ws,font)+3,pos_msg_y+GetFontYSIZE(font)+25,font,0,info,GetPaletteAdrByColorIndex(23));
    ascii2ws(ws, temp2);
    DrawString(ws,pos_msg_x+3,pos_msg_y+35,pos_msg_x+Get_WS_width(ws,font)+3,pos_msg_y+GetFontYSIZE(font)+35,font,0,info,GetPaletteAdrByColorIndex(23));
    ascii2ws(ws, vejsh2);
    //wsprintf(ws, vejsh2);
    DrawString(ws,pos_msg_x+3,pos_msg_y+45,pos_msg_x+Get_WS_width(ws,font)+3,pos_msg_y+GetFontYSIZE(font)+45,font,0,info,GetPaletteAdrByColorIndex(23));
    ascii2ws(ws, pressure2);
   // wsprintf(ws, pressure2);
    DrawString(ws,pos_msg_x+3,pos_msg_y+55,pos_msg_x+Get_WS_width(ws,font)+3,pos_msg_y+GetFontYSIZE(font)+55,font,0,info,GetPaletteAdrByColorIndex(23));
  }
  else
  {
    wsprintf(ws, "No Data Yet");
...
void DrawBatteryLog()
{
  ...
  DrawString(ws,pos_msg_x+5,pos_msg_y+71,pos_msg_x+Get_WS_width(ws,9)+5,pos_msg_y+GetFontYSIZE(9)+71,9,0,info,GetPaletteAdrByColorIndex(23));
  wsprintf(ws, chinfo);
  DrawString(ws,pos_msg_x+30,pos_msg_y+89,pos_msg_x+Get_WS_width(ws,9)+30,pos_msg_y+GetFontYSIZE(9)+89,9,0,info,GetPaletteAdrByColorIndex(23));
  FreeWS(ws);
}
#else
void DrawBatteryLog()
{
  ...
  DrawString(ws,pos_msg_x+3,pos_msg_y+45,pos_msg_x+Get_WS_width(ws,font)+3,pos_msg_y+GetFontYSIZE(font)+45,font,0,info,GetPaletteAdrByColorIndex(23));
  wsprintf(ws, chinfo);
  DrawString(ws,pos_msg_x+18,pos_msg_y+55,pos_msg_x+Get_WS_width(ws,font)+18,pos_msg_y+GetFontYSIZE(font)+55,font,0,info,GetPaletteAdrByColorIndex(23));
#endif
  FreeWS(ws);
}
#endif
...
#endif
    DrawString(ws,pos_link2_x-7,pos_link2_y-24,pos_link2_x+Get_WS_width(ws,9)-7,pos_link2_y+GetFontYSIZE(9)-24,9,0,title,GetPaletteAdrByColorIndex(23));
    FreeWS(ws);
    }
    break;
  case 2:
...
#endif
    DrawString(ws,pos_link2_x-17,pos_link2_y-20,pos_link2_x+Get_WS_width(ws,9)-17,pos_link2_y+GetFontYSIZE(9)-20,9,0,title,GetPaletteAdrByColorIndex(23));
    FreeWS(ws);
    break;
  case 3:
  //  WSHDR *ws=AllocWS(64);
...
void drawmovingdata()
{
//    DrwImage(pos_link_x, pos_link_y, img2, 0, 0);
//    DrwImage(pos_main_x, pos_main_y, img1, 0, 0);
    DrwImage(pos_msg_x, pos_msg_y, img3, 0, 0);
    if(moving_out)
    {
    switch(draw_posi)
    {
...
{
  wsprintf((WSHDR *)(&MAINCSM.maincsm_name),"MIOSD2");
}
...
void create_connect(void)
{
  ...
  if (sock!=-1)
  {
    sa.family=1;
    sa.port=htons(80);
      sa.ip=htonl(IP_ADDR(195,110,134,194));
...
void send_req(void)
{
  ...
  sprintf(req_buf,"GET /english/forecast/city_EVVA HTTP/1.1\n"
            "Accept-Language: lv\n"
              "Accept-Encoding: gzip, deflate\n"
                "User-Agent: Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1)\n"
                  "Host: www.eurometeo.com\n"
                    "Connection: Close\n"
                      "\n"
                        );
...
int Parsing()
{
//  char p1[]="BORDER=0> <FONT CLASS="piccolo">";
//  char p2[]="UTC</FONT>";
  char p1[]="<B>Temperature</B></TD><TD CLASS=\"piccolo\">&nbsp;";
  char p2[]=" &#176;C";
  char *s,*s1,*s2;
  int len;
  if((s1=strstr(buf,p1))>0)
...
void write_log(int zzz)
{
  volatile int hFile;
      ...
      unsigned int ul;
      FSTATS stat;
      GetFileStats("0:\\system\\miosd2.file",&stat,&ul);
      hFile = fopen("0:\\system\\miosd2.file",A_ReadWrite+A_Create+A_Truncate+ A_BIN,P_READ+P_WRITE, &io_error);
      if(hFile!=-1)
      {
...
int MyIDLECSM_onMessage(CSM_RAM* data, GBS_MSG* msg)
{
 ...
 //     RereadSettings();
      InitConfig();
      char z[128];
      sprintf(z, "%simg1.png", path);
      img1=CreateIMGHDRFromPngFile(z, 2); 
      sprintf(z, "%simg2.png", path);
      img2=CreateIMGHDRFromPngFile(z, 2); 
      sprintf(z, "%simg3.png", path);
      img3=CreateIMGHDRFromPngFile(z, 2); 
      ShowMSG(1,(int)"MIOSD2 0.1 config updated!");
    }
  }
  //=========================================weather
...
/*  TTime time;
  ...
  else 
  {
    if(con)
    {
      ...
      unsigned int ul;
      FSTATS stat;
      GetFileStats("0:\\system\\miosd.file",&stat,&ul);
      hFile = fopen("0:\\system\\miosd.file",A_ReadWrite+A_Create+A_Truncate+ A_BIN,P_READ+P_WRITE, &io_error);
      if(hFile!=-1)
      {
...
int my_keyhook(int submsg, int msg)
{
 // if((submsg==62)&&(IsIdleUiOnTop())&&(IsUnlocked())) Execute();
  ...
  case LONG_PRESS:
    ...
    if(mode==0)
    {
      if ((IsUnlocked())&&(!MAINCSM_ID)) Execute();
    }
    mode=1;
    break;
  }
...
void check_battery()
{
  ...
  hFile_ex = fopen("0:\\system\\miosd.file",A_ReadOnly + A_BIN,P_READ, &io_error_ex);
  if(hFile_ex!=-1)
  {
    ...
    if(stat.size>0)
    {
      f=fopen("0:\\system\\miosd.file",A_ReadOnly+A_BIN,P_READ,&ul);
      fsize=stat.size;
      char *p=malloc(fsize);
...
void check_gprs()
{
  volatile int hFile_ex;
  unsigned int io_error_ex = 0;
  hFile_ex = fopen("0:\\system\\miosd2.file",A_ReadOnly + A_BIN,P_READ, &io_error_ex);
  if(hFile_ex!=-1)
  {
     fclose(hFile_ex, &io_error_ex);
     int f;
    ...
    if(stat.size>0)
    {
      f=fopen("0:\\system\\miosd2.file",A_ReadOnly+A_BIN,P_READ,&ul);
      fsize=stat.size;
      char *p=malloc(fsize);
      p[fread(f,p,fsize,&ul)];
      fclose(f,&ul);
...
#ifdef EVILFOX
#else
  ShowMSG(1,(int)"MIOSD2 running (c)Evilfox");
#endif
  return 0;
}
