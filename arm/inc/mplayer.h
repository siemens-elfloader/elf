...
//0x05 хрень какая-то с кнопками...лагают....
//0x06 роняет
//0x07 рестарт
//0x08 рестарт
//0x09 рестарт
...
//0x17 mute? зануляет звук, но не возвращает его на место!
#define PLAYER_REPEAT1	0x18
//0x19 Вызывает окно Произошла ошибка
//0x20 ничего!
//0x21 роняет
//0x22 роняет!
//0x23 Плеер не реагирует на плей/паузу/стоп/volup/voldown
//0x24 Плеер не реагирует на плей/паузу/стоп/volup/voldown
//0x25 ничего!
//0x26 Плеер не реагирует на плей/паузу/стоп/volup/voldown
