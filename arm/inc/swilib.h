...
__swi __arm void srand3(unsigned int seed);
//thumb
...
__swi __arm int Obs_SetScaling (HObj hObj, int unk5);//0xF - preview, 0x5 normal,0x15 zoomed
...
__swi __arm void SLI_SetState(unsigned char state); //0-phone controls SLI 1- SLI on 2-SLI off

#pragma swi_number=0x07E 
__swi __arm int rand2();
...
__swi __arm void UpdateDisplayByLayerPtr(LCDLAYER*);
#pragma swi_number=0x80F6
__swi __arm unsigned int* Ram_Layer_Base_Ptr(void);
#pragma swi_number=0x79
__swi __arm void DrawObject2Layer(LCDLAYER*, DRWOBJ*);
