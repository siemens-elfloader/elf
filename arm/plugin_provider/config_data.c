...
__root const CFG_HDR cfghdr11= {CFG_LEVEL,"Сеть",1,0};
...
__root const CFG_HDR cfghdr6={CFG_STR_WIN1251,"Формат",0,127};
__root const char FORMAT[128]="Сеть %d дб";

__root const CFG_HDR cfghdr10= {CFG_LEVEL,"",0,0};


__root const CFG_HDR cfghdr21= {CFG_LEVEL,"Провайдер",1,0};
...
__root const CFG_HDR cfghdr14={CFG_STR_WIN1251,"Формат",0,127};
__root const char FORMAT2[128]="Оператор %s";

__root const CFG_HDR cfghdr15={CFG_STR_WIN1251,"Формат поиска сети",0,127};
__root const char FORMAT2_1[128]="Поиск сети...";
