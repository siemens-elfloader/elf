...
/* non-susv2 types: */
__extension__ typedef signed long loff_t;	/* 64-bit offset */

__extension__ typedef signed long off64_t;
...
__extension__ typedef unsigned long ino64_t;
__extension__ typedef signed long blkcnt64_t;
